...
--
-- Table structure for table `envio_electronico`
--
...
CREATE TABLE `envio_electronico` (
  ...
  `sunat_description` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `sunat_note` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `sunat_responsecode` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `sunat_soap_error` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `aceptada_por_sunat` tinyint(1) DEFAULT NULL,
  `usuario_envio` int(11) DEFAULT NULL,
  `envio_pse` tinyint(1) DEFAULT '0',
  `fecha_envio` datetime DEFAULT NULL,
  `fecha_mod` datetime DEFAULT NULL,
  `estado_envio` char(10) COLLATE utf8_unicode_ci DEFAULT NULL,
  `tipoenvio` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `fecha_emi` datetime DEFAULT NULL,
  `enlace` varchar(300) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `envio_electronico`
--

LOCK TABLES `envio_electronico` WRITE;
/*!40000 ALTER TABLE `envio_electronico` DISABLE KEYS */;
/*!40000 ALTER TABLE `envio_electronico` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `error_envio_electronico`
--
...
--
-- Dumping data for table `error_envio_electronico`
--

LOCK TABLES `error_envio_electronico` WRITE;
/*!40000 ALTER TABLE `error_envio_electronico` DISABLE KEYS */;
/*!40000 ALTER TABLE `error_envio_electronico` ENABLE KEYS */;
UNLOCK TABLES;
