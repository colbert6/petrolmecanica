...
function add_detalle_variable(){
    ...
    html += "<div class='col-xs-8 col-md-4 item' style='padding-bottom: 4px;' id_prod=\'"+idp+"\'>";
    html += "<div class='input-group'>";
    html += "<span class='input-group-btn'>";   
    html += "<button type='button' class='btn btn-danger btn-flat' ><i class='fa fa-times'  onclick=\'remover_detalle_venta("+idp+")\'></i></button>";
    html += "</span>";
    html += "<input class='form-control' name='prodtext[]' value=\'"+producto+"\' placeholder='descripción'>";
    html += "<input type='hidden' name='idprod[]'  value=\'"+idp+"\'>";
    html += "</div>  ";
    html += "</div>  ";

    html += "<div class='col-xs-4 col-md-2 item' style='padding-bottom: 4px;' id_prod=\'"+idp+"\'>";
    html += "<input class='form-control' name='prodtext[]'  placeholder='Codigo'>";
    html += "</div>  ";
    ...
    html += "<div class='col-xs-4 col-md-2 item_precio' style='padding-bottom: 4px;' id_prod=\'"+idp+"\'>";
    html += "<input type='number' name='prec[]' class='form-control' placeholder='Precio' tabindex='-1' value=\'"+precio_venta+"\'  onkeyup=\'calcular_subtotal("+idp+")\' onchange=\'calcular_subtotal("+idp+")\'>";
    html += "</div>";

    html += "<div class='col-xs-4 col-md-2 item_subtotal' style='padding-bottom: 4px;' id_prod=\'"+idp+"\'>";
    html += "<input type='number' class='form-control' readonly tabindex='-1'  value=\'"+precio_venta+"\'>";
    html += "</div>";
    html += "</div>";
