...
class Det_venta extends CI_Model {
    ...
    {    
        ...
        $this->db->select('
          ...
          ROUND(detv.cantidad)  as CANTIDAD_DET,
          detv.precioxpresentacion  as PRECIO_DET,
          ROUND(detv.precioxpresentacion * detv.cantidad,2) - ROUND( ROUND(detv.precioxpresentacion * detv.cantidad,2) / 1.18, 2) as IGV_DET,
          "0" as ICBPER_DET,
          "0" as ISC_DET,
          ROUND( (ROUND( ROUND(detv.precioxpresentacion * detv.cantidad,2) / 1.18, 2))  / detv.cantidad, 2) as PRECIO_SIN_IGV_DET,
          ROUND( ROUND(detv.precioxpresentacion * detv.cantidad,2) / 1.18, 2) as IMPORTE_DET,
          detv.producto_idproducto as "CODIGO_DET",
          detv.descripcion  as "DESCRIPCION_DET",
          "no" as DESCUENTO_ITEM,
          "0" as PORCENTAJE_DESCUENTO,
