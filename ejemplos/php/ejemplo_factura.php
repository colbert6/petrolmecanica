...
$cliente = array(
	"cliente_tipodocumento" 	=> "6", //Código del tipo de documento
	"cliente_numerodocumento" 	=> "20103290601", //Si es RUC: 11 dígitos, si es DNI: 8 digitos, si es OTRO DOC: 8 ceros o un guión
