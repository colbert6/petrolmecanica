...
$data['cod_tipo_documento'] 	= "08";
$data['serie_comprobante'] 		= "FD01"; //se recomienda utilizar una serie que inicie con FD para notas de crédito de Facturas, y una serie BD para notas de crédito de boletas.
...
$data['descripcion_motivo'] 		= "Aumento en el valor"; //obligatorio

$ruta = 'https://facturalahoy.com/api/facturalaya/nota_debito';
